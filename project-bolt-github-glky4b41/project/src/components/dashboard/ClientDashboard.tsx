...
import { orderOperations, packageOperations } from '../../utils/supabaseOperations';
...
const ClientDashboard: React.FC<ClientDashboardProps> = ({ onNavigate }) => {
  ...
  const loadData = async () => {
    ...
    try {
      setLoading(true);
      setError(null);
      const [userOrders, allPackages] = await Promise.all([
        orderOperations.getByClientId(user.id),
